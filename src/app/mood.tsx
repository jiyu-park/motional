...
export default function MoodEntryScreen() {
  ...
  const saveEntry = () => {
    ...
    router.replace({ pathname: '/calendar', params: { saved: '1' } });
  };
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          <View style={styles.heading}>
            ...
            <Text style={styles.description}>가장 가까운 감정 하나를 골라 주세요.</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  content: { gap: theme.spacing.xxxl, padding: theme.spacing.xl, paddingBottom: 140 },
  ...
  sectionTitle: { color: theme.colors.text, fontSize: theme.fontSize.titleMedium, fontWeight: '800' },
  sectionHint: {
